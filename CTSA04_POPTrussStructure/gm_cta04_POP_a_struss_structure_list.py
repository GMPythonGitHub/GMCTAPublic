...
# ---------------------------------------------------------
print("\n*** POP for solving Truss Structure: enhanced by using 'list' ***")
# ---------------------------------------------------------
...
for i in range(dfrd):
    if not fxc_glb[i]:
        ...
        for j in range(dfrd):
            if fxc_glb[j]:
                bb[ii] -= stf_glb[i][j] * dsp_glb[j]
        ii += 1
## --- section_c3: solving working matrix equation --- ##
...
# =========================================================
print('### --- section_d: calculating behavior of truss structure --- ###')
